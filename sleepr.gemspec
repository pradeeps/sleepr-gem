...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Pradeep Susarla"]
  spec.email         = ["pradeep@pradeeps.org"]

  spec.summary       = %q{Used to point out when people using our app are doing so after hours and should just go to sleep.}
